...
<div role="article" aria-roledescription="email" aria-label="Confirmation du rendez-vous" lang="en">
        ...
        <table align="center" cellpadding="0" cellspacing="0" role="none">
            <tr>
                <td style="width: 552px; max-width: 100%">
                    <div class="sm-my-8" style="margin-top: 48px; margin-bottom: 48px; border-top-left-radius: 4px; border-top-right-radius: 4px; background-color: #1e40af; padding: 4px 16px; text-align: center; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                        <a href="https://www.camer.be" style="text-decoration: none">
                            <h3 style="margin-bottom: 16px; display: flex; justify-content: center; text-align: center; font-size: 36px; font-weight: 600; color: #f1f5f9">Medi<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" style="height: 48px; width: 48px">
